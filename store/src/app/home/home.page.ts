...
export class HomePage implements OnInit {
  ...
  public count='';
  checkScreen() {
    this.count = window.innerWidth.toString();
    // let innerWidth = window.innerWidth;
    // switch (true) {
    //   case 992 > innerWidth:
    //     this.count=innerWidth.toString();
    //   case 992 <= innerWidth:
    //     this.count=innerWidth.toString();
    // }
  ...
  check(){
    ...
    constructor(private nav: NavController,private alt:AlertController,private rout:Router,private platform: Platform,private actionsheet:ActionSheetController) { 
  ...
  ngOnInit() {
    // if(!localStorage.getItem('lid') || localStorage.getItem('lid') == 'null'){
